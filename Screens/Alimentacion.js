...
class Alimentacion extends Component {
  ...
  render() {
      const pickerValues = [
      {
        title: '¿Come alimentos fritos?',
        value: '¿Masgunned masi masdibyaled?'
      },
      {
        title: '¿Come diariamente frutas y vegetales?',
        value: '¿Masgunned banebane sabbidurba dulemas?'
      },
      {
        title: '¿Come alimentos con mucha azúcar?',
        value: '¿Masgunned masi nagege ossi?'
      },
      {
        title: '¿Bebe al menos 8 vasos de aguas diario?',
        value: '¿Gobed issee Baabag isbe sole banebane?'
      },
    ...
    return (
      ...
      <View style={styles.container}>
        ...
        />
        <Text style={styles.texto}>Alimentación</Text>
