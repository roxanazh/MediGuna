...
class Toxicos extends Component {
  ...
  render() {
      ...
      {
        title: '¿Consume otras drogas?',
        value: '¿Gobed baid ina?'
      },
    ]
    return (
      ...
      <View style={styles.container}>
        ...
        />
        <Text style={styles.texto}>Toxicos</Text>
